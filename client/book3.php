    ...
    $calendar.= "<a class='btn btn-xs btn-primary' href='?month=".date('m', mktime(0, 0, 0, $month+1, 1, $year))."&year=".date('Y', mktime(0, 0, 0, $month+1, 1, $year))."'>Next Month</a></center><br>";
     ...
     while ($currentDay <= $numberDays) {
        ...
        elseif($date<date('Y-m-d')){
             ...
             $calendar.="<td class='$today'><h4>$currentDay</h4> <a href='book4.php?date=".$date."' class='btn btn-success btn-xs'>Book</a>";
         }
        $calendar .="</td>";
        $currentDay++;
        $dayOfWeek++;
...
<a href="logout.php" class="btn btn-primary" style="align-self:left">Log Out</a> 
</div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
