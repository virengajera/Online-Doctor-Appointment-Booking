...
<div class="container">
<h1>Search Reports by date range</h1> <br>

<form action="search_reports_by_range.php" method ="GET">

 <div class="form-group" >
    <label>Select Starting date</label>
    <input type="date" class="form-control w-50" name="start_date" required>
  </div>
  ...
  <div class="form-group" >
    ...
    <input type="date" class="form-control w-50" name="end_date"  required>
  </div>
